    ...
    <>
      ...
      <div className="border-t border-fuel/20 bg-fuel/[0.04] py-10">
        <div className="container text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-fuel mb-2">
            Ready to fuel the fight?
          </p>
          <h3
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/signup"
              className="inline-flex items-center justify-center gap-2 h-11 px-7 rounded-lg bg-fuel text-fuel-foreground font-semibold text-sm shadow-lg shadow-fuel/25 hover:bg-fuel/90 transition-colors"
            >
              Start a Campaign
            </Link>
            <Link
              to="/explore"
              className="inline-flex items-center justify-center gap-2 h-11 px-7 rounded-lg border border-border/60 text-sm font-medium hover:border-fuel/40 hover:text-fuel transition-colors"
            >
              Fuel an Activist
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 mb-8">
            <div className="col-span-2 sm:col-span-1">
              ...
              <p className="mt-3 text-xs text-muted-foreground leading-relaxed max-w-xs">
                ...
                <a
                  ...
                  className="text-foreground font-medium hover:text-fuel transition-colors"
                >
                  We The People News
                </a>{" "}
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <Link
                    to="/explore?category=investigative-journalism"
                    className="hover:text-foreground transition-colors"
                  >
                    Journalism
                  </Link>
                ...
                <li>
                  <Link
                    to="/explore?category=constitutional-rights"
                    className="hover:text-foreground transition-colors"
                  >
                    Rights Cases
                  </Link>
          ...
          <div className="border-t border-border/30 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-muted-foreground">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground/70 hover:text-fuel transition-colors"
              >
                We The People News
              </a>{" "}
              platform ·{" "}
